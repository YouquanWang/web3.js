...
describe('TransactionSignerTest', () => {
    ...
    it('calls sign and returns the expected resolved promise', async () => {
        const tx = {
            ...
            gasPrice: 'ds3b9aca00',
            nonce: 'ds3',
            to: 'dsb414031Aa4838A69e27Cb2AE31E709Bcd674F0Cb',
            value: 'ds64'
        };
        ...
        await expect(
            ...
            rawTransaction:
                'dsf86303843b9aca0082753094b414031aa4838a69e27cb2ae31e709bcd674f0cb648045a01fff9fa845437523b0a7f334b7d2a0ab14364a3581f898cd1bba3b5909465867a01415137f53eeddf0687e966f8d59984676d6d92ce88140765ed343db6936679e',
            r: 'ds1fff9fa845437523b0a7f334b7d2a0ab14364a3581f898cd1bba3b5909465867',
            s: 'ds1415137f53eeddf0687e966f8d59984676d6d92ce88140765ed343db6936679e',
            v: 'ds45',
            transactionHash: 'ds6a18d30b737db620210e8bc5f334eefc82d1769ea3c16576b25e1ec24ca014ba'
        });
    });
    ...
    it('calls sign with a prefixed pk and returns the expected resolved promise', async () => {
        ...
        await expect(
            transactionSigner.sign(tx, 'ds3a0ce9a362c73439adb38c595e739539be1e34d19c5e9f04962c101c86bd7616')
        ).resolves.toEqual({
            messageHash: '91e0ad336c23d84f757aa4cde2d0bb557daf5e1ca0a0b850b6431f3277fc167b',
            rawTransaction:
                'dsf86303843b9aca0082753094b414031aa4838a69e27cb2ae31e709bcd674f0cb648045a01fff9fa845437523b0a7f334b7d2a0ab14364a3581f898cd1bba3b5909465867a01415137f53eeddf0687e966f8d59984676d6d92ce88140765ed343db6936679e',
